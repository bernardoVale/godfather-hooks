...
536b9d6404b456cd5c9bba63cd2648d1d9053340"
        ...
        with mock.patch('modified_servers.run_command', return_value=mocked_result) as m:
...
536b9d6404b456cd5c9bba63cd2648d1d9053340 \n \
    ...
    def test_get_all_modified_servers(self):
        ...
        with mock.patch('modified_servers.get_modified_servers_from_commit', side_effect=mocked_results) as m:
            got = get_all_modified_servers(list_of_commits)
            expected = ["server1", "server2", "server3"]
            self.assertEqual(got, expected)

    def test_get_all_modified_servers_with_dups(self):
